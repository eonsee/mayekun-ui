...
性能优化是一个持续的过程，需要在开发中不断实践和调整。
    `,
    cover: 'https://picsum.photos/seed/react-perf/800/450',
    category: '前端开发',
    tags: ['React', '性能优化', '前端'],
    author: 'Mayekun',
...
微服务架构需要权衡利弊，适合的才是最好的。
    `,
    cover: 'https://picsum.photos/seed/microservice/800/450',
    category: '后端开发',
    tags: ['Node.js', '微服务', '架构'],
    author: 'Mayekun',
...
容器化是现代 DevOps 的基础，掌握 Docker 是必备技能。
    `,
    cover: 'https://picsum.photos/seed/docker/800/450',
    category: 'DevOps',
  ...
  },
  {
    ...
    summary: '从分支策略到代码审查，建立高效的 Git 工作流，提升团队协作效率。',
    content: `
# Git 工作流与团队协作规范
...
规范的 Git 工作流能有效减少冲突，提高代码质量。
    `,
    cover: 'https://picsum.photos/seed/gitflow/800/450',
    category: 'DevOps',
    tags: ['Git', '协作', '规范'],
    author: 'Mayekun',
  ...
  },
  {
    id: '8',
    title: 'Web 安全防护实战指南',
    summary: 'XSS、CSRF、SQL 注入...了解常见 Web 攻击手段及防御策略，守护应用安全。',
    content: `
# Web 安全防护实战指南
...
安全防护需要从开发阶段就开始重视，防患于未然。
    `,
    cover: 'https://picsum.photos/seed/websecurity/800/450',
    category: '后端开发',
    tags: ['安全', 'Web', '防护'],
    author: 'Mayekun',
  ...
  {
    id: '9',
    title: 'Pinia 状态管理从入门到精通',
    summary: '全面掌握 Vue 3 官方推荐的状态管理方案 Pinia，构建可维护的应用架构。',
    content: `
# Pinia 状态管理从入门到精通

Pinia 是 Vue 3 的官方状态管理库，比 Vuex 更简洁、更强大。
...
export const useUserStore = defineStore('user', () => {
  ...
  function login(n: string, t: string) {
    name.value = n
    token.value = t
  }
...
Pinia 简洁的 API 和完善的 TypeScript 支持，让状态管理变得轻松愉快。
    `,
    cover: 'https://picsum.photos/seed/pinia/800/450',
    category: '前端开发',
    tags: ['Vue', 'Pinia', '状态管理'],
    author: 'Mayekun',
  ...
  },
  {
    id: '10',
    title: 'Vite 构建工具深度解析',
    summary: '深入理解 Vite 的工作原理，掌握构建优化技巧，提升开发体验。',
    content: `
# Vite 构建工具深度解析

Vite 利用浏览器原生 ES Module，实现了极速的开发体验。

## 核心原理

### 开发模式

- 利用浏览器原生 ESM，无需打包即可运行
- 按需编译，只编译当前页面用到的模块

### 生产构建

- 基于 Rollup 进行打包
- 支持代码分割、Tree-shaking 等优化
...
Vite 的出现彻底改变了前端构建工具的格局，是现代前端项目的首选。
    `,
    cover: 'https://picsum.photos/seed/vite/800/450',
    category: '前端开发',
    tags: ['Vite', '构建工具', '前端'],
    author: 'Mayekun',
...
export const profile: Profile = {
  name: 'oaken',
  avatar: 'https://picsum.photos/seed/avatar-dev/200/200',
  ...
  skills: [
    ...
    { name: 'Spring Cloud', icon: 'spring', url: 'https://spring.io/projects/spring-cloud' },
    { name: 'MyBatis', icon: 'mybatis', url: 'https://mybatis.org' },
    ...
    { name: 'Elasticsearch', icon: 'elasticsearch', url: 'https://www.elastic.co' },
    ...
    { name: 'Maven', icon: 'maven', url: 'https://maven.apache.org' },
